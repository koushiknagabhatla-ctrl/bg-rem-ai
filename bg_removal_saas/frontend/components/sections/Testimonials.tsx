...
export function Testimonials() {
  ...
  return (
    <section ref={container} className="py-32 md:py-56 w-full relative overflow-hidden bg-[#0A0604] border-t border-[#1F140D]">
      
      {/* Cinematic Bronze Glow Background */}
      ...
      <div className="relative w-full max-w-[1400px] mx-auto px-6 md:px-16">

...
export function FinalCTA() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-40 md:py-56 px-6 md:px-16 overflow-hidden bg-[#0C0806]"
    >
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] max-w-[1200px] max-h-[1200px] bg-[radial-gradient(ellipse_at_center,_rgba(139,94,60,0.15)_0%,_transparent_70%)] pointer-events-none" />
      ...
      <div className="max-w-[900px] mx-auto text-center relative z-10 glass3d p-16 md:p-24 border border-[#8B5E3C]/20">
        <motion.div

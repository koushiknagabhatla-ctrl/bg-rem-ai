...
export function SignInCard() {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden flex flex-col items-center justify-center px-4">
      ...
      <div className="fixed bottom-0 left-0 w-full h-[300px] bg-gradient-to-t from-violet-900/10 to-transparent pointer-events-none" />

      {/* Floating orbs */}
      <div className="fixed top-[20%] left-[20%] w-[300px] h-[300px] bg-violet-600/8 rounded-full blur-[120px] pointer-events-none animate-orb-1" />
      <div className="fixed bottom-[20%] right-[15%] w-[250px] h-[250px] bg-cyan-500/6 rounded-full blur-[100px] pointer-events-none animate-orb-2" />

      {/* Back to home */}
      <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} className="absolute top-6 left-6 z-20">
        <Link href="/" className="flex items-center gap-2 text-white/25 hover:text-white/50 text-sm transition-colors font-tech">
      ...
      <motion.div initial={{ opacity: 0, y: 20, scale: 0.98 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
        ...
        <div className="glass-card p-8">
          ...
          <h1 className="text-3xl font-black tracking-tight mb-2 font-display">Welcome back</h1>
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-[11px] text-white/20 uppercase tracking-wider font-tech">or email</span>
            <div className="flex-1 h-px bg-white/[0.06]" />
          </div>

...
const colorVariants: Record<ColorVariant, { outer: string; inner: string; button: string; textColor: string; textShadow: string }> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#2d1b69] to-[#8b5cf6]",
    inner: "bg-gradient-to-b from-[#8b5cf6] via-[#4c1d95] to-[#7c3aed]",
...
export { LiquidButton, liquidbuttonVariants, MetalButton, GlassFilter };
